...
PROMPT_ANSWER = {
    ...
    'a6': ("", "fill in ques"),                               # 对应p5,将每个答案和问题进行组合
...
PROMPT_INSTRUCTION_old = "p6"
PROMPT_INSTRUCTION_new = "p7"

PROMPT_QUESTION_old = "q1"
PROMPT_QUESTION_new = "q1"

PROMPT_ANSWER_old = "a1"
PROMPT_ANSWER_new = "a6"
...
frerank_data_train_old = data_dir + dataset + "_rerank_data_train_rs_"+file_prefix_old+"_Top50.json"                # file_prefix_old # TODO t2
frerank_data_valid_old = data_dir + dataset + "_rerank_data_valid_rs_"+file_prefix_old+"_Top50.json"                # t2
frerank_data_test_old = data_dir + dataset + "_rerank_data_test_rs_"+file_prefix_old+"_Top50.json"                  # t1                  
frerank_data_test_kf_old = data_dir + dataset + "_rerank_data_test_rs_"+file_prefix_old+"_Top50_kf3.json"           # t1
frerank_data_train_new = data_dir + dataset + "_rerank_data_train_rs_"+file_prefix_new+"_Top50.json"      
frerank_data_valid_new = data_dir + dataset + "_rerank_data_valid_rs_"+file_prefix_new+"_Top50.json"      
frerank_data_test_new = data_dir + dataset + "_rerank_data_test_rs_"+file_prefix_new+"_Top50.json"     
frerank_data_test_kf_new = data_dir + dataset + "_rerank_data_test_rs_"+file_prefix_new+"_Top50_kf3.json"     
...
def process_input_output_fillin(frerank_data_old, frerank_data_new):
...
process_input_output_fillin(frerank_data_train_old, frerank_data_train_new)
process_input_output_fillin(frerank_data_valid_old, frerank_data_valid_new)
process_input_output_fillin(frerank_data_test_old, frerank_data_test_new)
process_input_output_fillin(frerank_data_test_kf_old, frerank_data_test_kf_new)
...
'Below is an instruction that describes a task, paired with a question and corresponding candidate answers. Combine what you know, output a ranking of these candidate answers.\n\n'
'Below is an instruction that describes a task, paired with a question and corresponding candidate answers. The questions and candidate answers have been combined into candidate corresponding statements. Combine what you know, output a ranking of these candidate answers.\n\n'

'Below is an instruction that describes a task, paired with a question and corresponding candidate answers. Combine what you know and the following knowledge, output a ranking of these candidate answers.\n\n'
'Below is an instruction that describes a task, paired with a question and corresponding candidate answers. The questions and candidate answers have been combined into candidate corresponding statements. Combine what you know and the following knowledge, output a ranking of these candidate answers.\n\n'


### Supporting information: longevity be very important to business; warren buffett be part of business exchange; phoenix be a business of body\n\n'
